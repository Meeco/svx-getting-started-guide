...
export const STEPS: Step[] = [
  ...
  { id: "admin-accounts", route: "/wallet/admin/accounts", group: "wallet-setup", order: 5, icon: ShieldCheck, terms: ["admin-account", "wallet"] },
  { id: "wallet-settings", route: "/wallet/admin/settings", group: "wallet-setup", order: 6, icon: Settings2, terms: ["wallet", "kms"] },

  // 3. Issue credentials
  { id: "schemas", route: "/wallet/credentials/schemas", group: "issue", order: 7, icon: FileJson2, terms: ["schema", "verifiable-credential"] },
  ...
  { id: "issued-credentials", route: "/wallet/credentials/issued", group: "issue", order: 9, icon: BadgeCheck, terms: ["issued-credential", "holder", "issuer"] },

  // 4. Verify credentials
  { id: "verification-templates", route: "/wallet/credentials/verification-templates", group: "verify", order: 10, icon: ClipboardList, terms: ["verification-template", "verifier", "presentation-request"] },
